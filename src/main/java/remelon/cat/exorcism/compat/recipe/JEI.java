...
import remelon.cat.exorcism.compat.recipe.category.ExorcisingCategoryJEI;
...
public class JEI implements IModPlugin {
	private static final Identifier JEIID = Exorcism.GenID("jei_plugin");
	...
	private void loadCategories() {
		...
		CreateRecipeCategory<?>
				...
				.build("fan_exorcising", ExorcisingCategoryJEI::new)
				;
	}
	...
	private class CategoryBuilder<T extends Recipe<?>> {
		...
		public CreateRecipeCategory<T> build(String name, CreateRecipeCategory.Factory<T> factory) {
			...
			CreateRecipeCategory.Info<T> info = new CreateRecipeCategory.Info<>(
					new mezz.jei.api.recipe.RecipeType<>(Exorcism.GenID(name), recipeClass),
					Lang.translateDirect(Exorcism.ID + ".recipe." + name), background, icon, recipesSupplier, catalysts);
