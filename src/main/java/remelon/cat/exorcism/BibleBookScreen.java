...
public class BibleBookScreen extends Screen {
	// Define an identifier for our custom button texture
	...
	public void render(DrawContext context, int mouseX, int mouseY, float delta) {
		...
		for (BookEntry book : this.filteredBooks) {
			if (y + 20 > viewTop && y < viewBottom) {
				...
				// ⭐ CHANGE: Draw a texture instead of a filled rectangle
				int vOffset = hovered ? 20 : 0; // Use bottom half of texture when hovered
	...
	public boolean mouseClicked(double mouseX, double mouseY, int button) {
		// ... (mouseClicked logic remains the same)
	...
	// ... (mouseScrolled, mouseDragged, mouseReleased, and close methods remain the same)
	@Override
